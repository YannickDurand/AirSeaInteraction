...
PATH='/dsk1/ydurand/fplane/CONF1/Case_wh_qtW_ACyclone'
...
#-------------------------load grid-------------------------------------------#
xxx,si_x,nbIter=dimRes(dataNetCDFS)
si_y=si_x
...
#%==================== LOAD FIELDS ===================================
#RC    = mit.rdmds(dir0+'RC*') ====> Coordinate of the cell center zzc in my notation
...
#%%
t=1
dtdt, dsdt, advrt, advxt, advyt, advrs, advxs, advys, wb2, wb = dataDiagPE(dataNetPE,t)
dtdt = dtdt/86400
dsdt = dsdt/86400
